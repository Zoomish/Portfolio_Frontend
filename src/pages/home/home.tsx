...
const Home: FC<IMenu> = ({ user, dark }) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full h-full relative mb-40'>
      ...
      <p className='text-xl text-center mb-6'>
        Мой опыт работы{' '}
        <span className='text-nowrap bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded text-white px-2 py-1'>
